...
const NAV = [
  ...
  { label: "Showcase", href: "/admin/cms/showcase" },
  ...
  // Users, Audit are added in later milestones.
];

// Admin shell (Phase 6 IA §4). Middleware ensures a session; here we enforce the
// real permission. Any admin-surface permission grants entry; per-page guards refine.
